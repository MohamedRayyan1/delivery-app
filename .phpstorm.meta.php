...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'services.slack.geoapify.key' => 'NULL',
...
'services.slack.notifications.channel','services.slack.geoapify.key','session.driver','session.lifetime','session.expire_on_close',
...
'session.http_only','session.same_site','session.partitioned','scramble.api_path','scramble.api_domain',
...
'scramble.extensions','octane.server','octane.https','octane.listeners.Laravel\\Octane\\Events\\WorkerStarting','octane.listeners.Laravel\\Octane\\Events\\RequestReceived',
...
'octane.watch','octane.garbage','octane.max_execution_time','flare.key','flare.flare_middleware',
...
'sanctum.csrf-cookie','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','scramble.docs.ui','scramble.docs.document',);
